...
class BrokerService:
    def __init__(self):
        ...
        from app.services.logger import centralized_logger, ConsoleLogStrategy, WebSocketLogStrategy
    ...
    async def log_event(self, event_type: str, client_id: str, topic: str = None, message: str = None):
    ...
    async def _send_safe(self, client_id: str, ws: WebSocket, data: str) -> str | None:
        ...
        try:
            ...
            logger.warning(f"Connection failure for client {client_id}. Scheduling cleanup.")
            return client_id
